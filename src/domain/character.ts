// The D&D character layer (docs/prds/done/20260705-nbutko-m3-character-sheet.html) — the persistent hero that
...
export interface Character {
  ...
  level: number
  // A running total that crosses level thresholds automatically (docs/prds/done/20260705-nbutko-m3-character-sheet.html
...
// 15 -> +2, 20 -> +5. See docs/prds/done/20260705-nbutko-m3-character-sheet.html.
